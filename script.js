    ...
    <div class="max-w-4xl mx-auto space-y-4 text-xs">
      ...
      ${
        ...
        <div class="bg-white p-5 rounded-3xl border shadow-sm space-y-3">
          ...
          <div class="prose max-w-none text-slate-800 leading-relaxed font-medium bg-slate-50 p-4 rounded-2xl border border-slate-200/80 whitespace-pre-line text-xs">
            ${isiTeks}
          </div>
        </div>
      `
      ...
      ${
        ...
        <div class="bg-white p-5 rounded-3xl border shadow-sm space-y-3">
          ...
          <div class="flex items-center justify-between p-2 bg-slate-50 rounded-2xl border">
            ...
            <div class="flex items-center gap-1.5">
              <button onclick="undoCanvas()" class="px-3 py-1 bg-amber-100 text-amber-800 font-bold rounded-xl text-[10px] hover:bg-amber-200 transition">↩️ Undo</button>
              <button onclick="clearCanvas()" class="px-3 py-1 bg-red-100 text-red-700 font-bold rounded-xl text-[10px] hover:bg-red-200 transition">🗑️ Clear</button>
            </div>
          </div>
